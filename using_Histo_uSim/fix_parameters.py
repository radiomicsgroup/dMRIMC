...
sig_arr = np.load("signal_arr_subset_one_diff_time.npy")
param_arr = np.load("param_arr_subset.npy")
...
output_param_path = f"{name}_fixed_params.npy"
output_sig_path = f"{name}_fixed_sig.npy"
